...
components_choice_wxwidgetsFrame::components_choice_wxwidgetsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, id, _("Êîìïîíåíòû âûáîðà"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("id"));
    ...
    RadioBox1 = new wxRadioBox(this, ID_RADIOBOX1, _("Âûáåðè"), wxPoint(224,16), wxSize(128,208), 6, __wxRadioBoxChoices_1, 1, 0, wxDefaultValidator, _T("ID_RADIOBOX1"));
    Button1 = new wxButton(this, ID_BUTTON1, _("Âûõîä"), wxPoint(264,240), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
    Center();
...
void components_choice_wxwidgetsFrame::OnCheckBox1Click(wxCommandEvent& event) {
    ...
    if (b == true) {
        StaticText1 -> SetLabel("Äà!");
    } else {
        StaticText1 -> SetLabel("Íåò!");
    }
}
